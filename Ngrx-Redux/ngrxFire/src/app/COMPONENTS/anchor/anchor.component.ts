...
export class AnchorComponent implements OnInit {
  ...
  constructor() {
    this.anchorPosition = { left: 20, top: 20 }; // Първоначалната позиция от където се показва anchor
		this.anchorMouseOffset = { left: 0,	top: 0 };

		this.popupPosition = {left: -1000, top: -1000 };
